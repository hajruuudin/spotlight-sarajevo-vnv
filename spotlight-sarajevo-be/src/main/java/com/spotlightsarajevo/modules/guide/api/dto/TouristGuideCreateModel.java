...
@Data
@Schema(description = "Properties for a tourist guide creation entity.")
public class TouristGuideCreateModel implements Serializable {
    ...
    private List<TouristGuideSectionCreateModel> sections;
    ...
    @Schema(description = "Id of the category the guide belongs to")
